...
postRouter.get('/:id', postController.get); // Route to get a specific post of an user
...
postRouter.delete('/:id', postController.delete); // Route to delete a specific post
